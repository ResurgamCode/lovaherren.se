	...
	<div id="content">
		<div id="content-inner">
			...
			<p>
				...
				till kyrkoårets olika gudstjänster.Dessutom finns, förutom vanliga vers-
				och författarregister, ett kyrkoårsregister med förslag på sånger som passar
			...
			<p>
				...
				sångböckerna har varit identitetsbärande. Vår mediekonsumtion har i hög

				utsträckning förflyttats till våra telefoner och därför kommer Lova Herren -20 även ut som en mobilapp.
				En ”prova-på”-version finns att ladda ner

				gratis för Android och Iphone.
				Lova Herren -20 är en sångbok med gamla och nya sånger som förkunnar

				Kristus och vägleder oss genom livet. Den passar lika bra för personlig andakt i hem och familj som i
			...
			<div class="prices">
				...
				<p>7 st Sångbok Standard, 2 st Sång- bok Skinnband, 1 st Notbok</p>
				<div class="row">
					<strong>
			...
			<p>Lova Herren finns att förhandsbeställa från <a href="http://www.bvforlag.se">BV-förlag</a> och leverans
				beräknas till första veckan. Betalning
				sker
				via faktura i samband med leverans.
			</p>
